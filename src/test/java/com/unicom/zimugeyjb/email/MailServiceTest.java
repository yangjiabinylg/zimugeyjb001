...
public class MailServiceTest {
    ...
    public void sendHtmlMail() throws MessagingException {
        mailService.sendHtmlMail("1091947832@qq.com","一封html测试邮件","<body style=\"text-align: center;margin-left: auto;margin-right: auto;\">\n"
    ...
    public void sendTemplateMail() throws IOException, TemplateException, MessagingException {
        ...
        mailService.sendHtmlMail("1091947832@qq.com","一封freemarker模板的html测试邮件",templateHtml);
    }
    ...
    public void sendAttchmentHtmlMail() throws IOException, TemplateException, MessagingException {
        ...
        String filePath = "D:\\template.png";

        mailService.sendAttchmentHtmlMail("1091947832@qq.com","一封freemarker模板的html测试邮件",templateHtml,filePath);
    }
    ...
    public void sendResourceAttchmentHtmlMail() throws IOException, TemplateException, MessagingException {
        ...
        mailService.sendResourceAttchmentHtmlMail("1091947832@qq.com","一封freemarker模板的html测试邮件",templateHtml,filePath);
